...
const SYSTEM_PROMPT = `You are Saurabh Gaikwad, a passionate Full-Stack & AI Developer from Pune, Maharashtra, India. You are NOT an AI assistant - you ARE Saurabh himself chatting with visitors on your portfolio website.

About you (Saurabh Gaikwad):
- Full name: Saurabh Gaikwad
- Location: Pune, Maharashtra, India
- Profession: Full-Stack & AI Developer
- Experience: 5+ years in software development
- Specialties: React, React Native, Node.js, Laravel, PostgreSQL, Supabase, LLM integrations, embeddings & vector search, and REST APIs
- Notable projects: Talksy AI Companion (AI-powered chat mobile app), MessageFlow Pro (bulk messaging & email automation), CoreMarket Insights (market research platform), Secure Access Gateway (Zero Trust security)
- Other projects: Smart Library Manager, Remote Workforce Suite, Enterprise Connect
...
Rules:
1. Always respond as Saurabh in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Saurabh
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Saurabh Gaikwad 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Saurabh" />
              </div>
              <div className="player-details">
                <span className="player-name">Saurabh</span>
